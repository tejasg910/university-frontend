                    ...
                    <div className="md:flex no-wrap md:-mx-2 ">
                        ...
                        <div className="w-full md:w-3/12 md:mx-2">
                            ...
                            <div className="bg-white p-3 border-t-4 border-green-400">
                                ...
                                <h1 h1 className="text-gray-900 font-bold text-xl leading-8 my-1"> {userDetails.firstName} {userDetails.lastName}</h1>


                                <h3 className="text-gray-600 font-lg text-semibold leading-6">{userDetails.biotitle}</h3>
                                <p className="text-sm text-gray-500 hover:text-gray-600 leading-6">{userDetails.bioinfo}</p>
                                <ul
                                    ...
                                    <li className="flex items-center py-3">
                                        ...
                                        <span className="ml-auto">
                                            ...
                                            {userDetails.status == "active" && <span
                                                className="bg-green-500 py-1 px-2 rounded text-white text-sm">{userDetails.status}</span>}
                                            {userDetails.status == "inactive" && <span
                                                className="bg-red-500 py-1 px-2 rounded text-white text-sm">{userDetails.status}</span>}
                                        </span>

                                    </li>
                                    <li className="flex items-center py-3">
                                        <span>Member since</span>
                                        <span className="ml-auto">{userDetails.joined}</span>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div className="text-gray-700">
                                    <div className="grid md:grid-cols-2 text-sm">
                                        ...
                                        <div className="grid grid-cols-2">
                                            ...
                                            <div className="px-4 py-2">+91 {userDetails.mobile}</div>
                                        </div>
                                        <div className="grid grid-cols-2">
                                        ...
                                        <div className="grid grid-cols-2">
                                            ...
                                            <div className="px-4 py-2">{userDetails.birthdate}</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1  md:grid-cols-2">
                                    <div>
                                        <div className="flex items-center space-x-2 font-semibold text-gray-900 leading-8 mb-3">
                                            ...
                                            <span className="tracking-wide">Special Achievements</span>
                                        </div>
                                        <ul className="list-inside space-y-2">

                                            {
                                                achieve.map((value, i) => {
                                                    ...
                                                    return <li key={i}>
                                                        <div className="text-teal-600">{value.title}</div>
                                    ...
                                    <div>
                                        ...
                                        <ul className="list-inside space-y-2">
                                            {pastEd.map((value) => {
                                                return <li>
                                                    <div className="text-teal-600">{value.title}</div>
                                                    <div className="text-gray-500 text-xs">{value.year}</div>
                                                </li>
                                            })}

...
const Home = () => {
  ...
  <li>AI DEVELOPMENT</li>
          ...
          <a
            href="#"
            class="my-2 shadow-md w-[100%] relative block overflow-hidden rounded-lg border border-gray-100 p-8"
          >
            <span
            ...
            <dl class="mt-6 flex">
              ...
              <div class="ml-3 flex flex-col-reverse sm:ml-6">
                <dt class="text-sm font-medium text-gray-600">Learning time</dt>
                <dd class="text-xs text-gray-500">1 Year</dd>
              </div>
            </dl>
          </a>
          ...
          >
            ...
            <div class="justify-between sm:flex">
              <div>
                ...
                <p class="mt-1 text-xs font-medium text-gray-600">By Alexa Mattue</p>
              </div>
          ...
          >
            ...
            <div class="justify-between sm:flex">
              <div>
                ...
                <p class="mt-1 text-xs font-medium text-gray-600">By Jimmy Walter</p>
              </div>
          ...
          >
            ...
            <div class="justify-between sm:flex">
              <div>
                ...
                <p class="mt-1 text-xs font-medium text-gray-600">By Kimmy Patt</p>
              </div>
